/*! iFrame Resizer (iframeSizer.min.js ) - v4.3.4 - 2023-02-18
...
!(function (d) {
  ...
  function H(o) {
    function i(e) {
      ...
      !a &&
        ...
        new e(t).observe(n, { attributes: !0, attributeOldValue: !1, characterData: !0, characterDataOldValue: !1, childList: !0, subtree: !0 }))
    }
    function e(e) {
      var n
      ;(n = e),
        o.id
          ? ((o.iframe.style[n] = o[n] + "px"), O(o.id, "IFrame (" + r + ") " + n + " set to " + o[n] + "px"))
    ...
    function r() {
      ...
      t && "contentWindow" in t && null !== t.contentWindow
        ? ((e = k[o] && k[o].targetOrigin),
          O(o, "[" + n + "] Sending msg to iframe[" + o + "] (" + i + ") targetOrigin: " + e),
  ...
  function s(t, i) {
    ...
    function n(e) {
      ...
      k[r] &&
        (k[r].targetOrigin =
          !0 !== k[r].checkOrigin || "" === (e = k[r].remoteHost) || null !== e.match(/^(about:blank|javascript:|file:\/\/)/) ? "*" : e)
    }
    var r = (function (e) {
    ...
    if (r in k && "iFrameResizer" in t) R(r, "Ignored iFrame, already setup.")
      ...
      s("Height"),
        ...
        a("maxWidth"),
        a("minWidth"),
        ("number" != typeof (k[r] && k[r].bodyMargin) && "0" !== (k[r] && k[r].bodyMargin)) ||
          ((k[r].bodyMarginV1 = k[r].bodyMargin), (k[r].bodyMargin = k[r].bodyMargin + "px")),
        e(L(r)),
        k[r] &&
  ...
  function n() {
    ...
    return (
      ...
      function (e, n) {
        ...
        switch (
          ((o = []),
          (i = e) && i.enablePublicMethods && R("enablePublicMethods option has been removed, public methods are now always available in the iFrame"),
          typeof n)
        ) {
          case "undefined":
          case "string":

                ...
                <div className='flex flex-col content-start  w-2/4 ml-24'>
                    ...
                    <div className='flex mt-12'>
                        ...
                        <div className='flex flex-col mr-18 bg-black text-white w-3/5 h-20 p-2 rounded-md'>
                            <div className=' text-sm font-medium '><span>I love how user-friendly this app is! It's so easy to add events and set reminders!</span></div>
                            <div className=' text-sm mt-1.5 font-medium text-slate-400'><span>Adam, entrepreneur </span></div>
                        </div>
                    </div>
                </div>

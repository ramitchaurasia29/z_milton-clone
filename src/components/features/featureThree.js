            ...
            <div className='flex w-3/4 mt-28 mb-10'>
                ...
                <div className='flex flex-col content-start  w-2/4 mr-24'>
                    ...
                    <div className='flex mt-20'>
                        <div className='mt-20 mr-4'><img src='./images/user-girl.png' alt='$' /></div>
                        <div className='flex flex-col mr-18 bg-black text-white w-4/5 h-24 p-2 rounded-md'>
                            <div className=' text-sm font-medium'><span>I've tried a lot of calendar apps, but this one is by far the best! It's so intuitive and customizable, and it has all the features I need.</span></div>
                            <div className=' text-sm mt-1.5 font-medium text-slate-400'><span>Annie, Designer</span></div>
                        </div>
                    </div>
                </div>
